...
//create start screen
	...
	function q2(){
	$("#mainBody").empty();
	//create questions - QUESTION 2 -
	var q1 = $("<p></p>").html("<h2>" + "Andy has NOT names his cat which of these names?" + "</h2>");
	//create answers - ANSWERS 1 -
	var q1a1 = $("<button></button>").text("Killer");
	var q1a2 = $("<button></button>").text("Apey");
	var q1a3 = $("<button></button>").text("Pants");
	//load the questions and answers to the page
	$("#mainBody").append(q1, q1a1, q1a2, q1a3); 
